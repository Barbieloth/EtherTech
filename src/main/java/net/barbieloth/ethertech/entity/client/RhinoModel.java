package net.barbieloth.ethertech.entity.client;// Made with Blockbench 5.0.4
...
public class RhinoModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(EtherTech.MOD_ID + ":rhinomodel"), "main");
